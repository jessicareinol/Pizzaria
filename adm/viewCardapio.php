...
<head>
    ...
    <title>La Bella Pizzaria - Detalhes do Item</title>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow">
                    <div class="card-header bg-success text-white text-center">
                        <h2><i class="fas fa-pizza-slice me-2"></i>Detalhes do Produto</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="listCardapio.php" class="btn btn-outline-secondary">
